...
To do:
    ...
    3. Rewrite each solve as a class, which can do different things:
        solve
        ...
        compare human vs computer comp[lexity]
...
6. Naked Quads
7. Hidden Quads
8. Pointing Pairs and Box Line Reduction. I've grouped these together into 'reduction' so it'll be a bit faster. but I'd like to split them out later
